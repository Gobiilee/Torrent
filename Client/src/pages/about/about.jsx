          ...
          <div className="row text-center">
            <div className="col-xl-3 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4">
                ...
                />
                <h5 className="mb-0">Lê Anh Kiệt - 20127542</h5>
                <span className="small text-uppercase text-muted">
                  Project manager, Developer (Front end), Data analysis
                </span>
            ...
            <div className="col-xl-3 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4">
                <img
                  ...
                  className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
                />
                <h5 className="mb-0">Trần Tiến Hoàng - 20127424</h5>
                <span className="small text-uppercase text-muted">
                  Developer (Back end), Data analysis
                </span>
                <ul className="social mb-0 list-inline mt-3">
                  <li className="list-inline-item">
                    <a href="#" className="social-link">
            ...
            <div className="col-xl-3 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4">
                <img
                  ...
                  className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
                />
                <h5 className="mb-0">Lê Võ Huỳnh Thanh - 20127072</h5>
                <span className="small text-uppercase text-muted">
                  Developer (Front end), Data manager, Designer (UI prototype)
                </span>
                <ul className="social mb-0 list-inline mt-3">
                  <li className="list-inline-item">
                    <a href="#" className="social-link">
            ...
            <div className="col-xl-3 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4">
                <img
                  ...
                  className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
                />
                <h5 className="mb-0">Nguyễn Quốc Thắng - 20127627</h5>
                <span className="small text-uppercase text-muted">
                  Developer (Back end), Tester{" "}
                </span>
                <ul className="social mb-0 list-inline mt-3">
                  <li className="list-inline-item">
                    <a href="#" className="social-link">
            ...
            <div className="col-xl-3 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4">
                <img
                  ...
                  className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
                />
                <h5 className="mb-0">Lâm Kim Nhân - 20127579</h5>
                <span className="small text-uppercase text-muted">
                  Developer (Front end), Tester
                </span>
                <ul className="social mb-0 list-inline mt-3">
                  <li className="list-inline-item">
                    <a href="#" className="social-link">
