...
//add db
const addDBimages = async (id, imageName, idUser, description, hashValue) => {
    await db.sequelize.query(`INSERT INTO images (id, imageName, idUser, description, hashValue) VALUES ('${id}', '${imageName}', '${idUser}', '${description}', '${hashValue}')`);
};
//check tag
